const String FirmwareVersion = "015910";
#define HardwareVersion "MCU101 for 4XX Series."
//Format                _X.XX__
//NIXIE CLOCK NCM101 4xx v1.0 by GRA & AFCH (fominalec@gmail.com)
//1.591 13.05.2026 - Reduced SPI speed to improve the stability of the K155ID1
//1.59 03.11.2023
//Added: Night Mode
//1.58 03.02.2023 
...
//                            names:  Time,              Date,        Alarm,            12/24,         Temperature,      Night Mode     hours,     mintues,     seconds,   DateFormat,       day,       month,        year,        hour,        minute,       second,     alarm01,      hour_format,    DegreesFormat,         TempAdj,           OffHour,         OnHour         
...
int value[SettingsCount] = {           0,                  0,           0,                0,                0,               0,           0,          0,            0,   EU_DateFormat,       0,          0,            0,          0,            0,            0,            0,            24,               0,                 0,                 8,                8         };
...
#ifdef tubes8
      stringToDisplay = PreZero(value[AlarmHourIndex]) + PreZero(value[AlarmMinuteIndex]) + PreZero(value[AlarmSecondIndex]) + F("00");
#endif
#ifdef tubes6
...
#ifdef tubes8
      stringToDisplay = String(F("00")) + String(value[hModeValueIndex]) + F("0000");
#endif
#ifdef tubes6
...
{
#ifdef tubes8
  if (value[hModeValueIndex] == 24) return PreZero(hour()) + PreZero(minute()) + PreZero(second()) + (millis() % 1000) / 100 + F("0");
