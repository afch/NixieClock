...
void loop() {
  ...
  switch (menuPosition)
  {
    ...
    case DateIndex: //date mode
      #ifdef tubes8
      stringToDisplay=PreZero(day())+PreZero(month())+year();
      #endif
      #ifdef tubes6
...
String updateDisplayString()
{
  ...
  if ((millis()-lastTimeStringWasUpdated)>10)
  {
    ...
    //Serial.println((int)(millis()%1000)/100+"0");
    #ifdef tubes8
...
void doTest()
{
  ...
  String testStringArray[13]={"00000000","11111111","22222222","33333333","44444444","55555555","66666666","77777777","88888888","99999999","","",""};

  testStringArray[11]=FirmwareVersion;
  //testStringArray[12]="00"+PreZero(celsius)+"00";
  testStringArray[12]="00000000";
  //Serial.print(F("Temp = "));
